...
- Ensure the app is responsive to different mobile screen sizes.

## Acceptance Criteria
- App successfully runs on the emulator/device.
- Bottom navigation bar allows switching between the three main sections.
- Riverpod is correctly configured at the app root.

## Out of Scope
- Actual integration with HealthKit/Health Connect (step tracking).
